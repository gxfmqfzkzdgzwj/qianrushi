...
copy "%ROOTDIR%\config\mcu\MK22F51212\mqx_sdk_config.h" "%OUTPUTDIR%\..\config\mqx_sdk_config.h" /Y
copy "%ROOTDIR%\config\board\usbkw019032_k22f\user_config.h" "%OUTPUTDIR%\..\config\user_config.h" /Y
